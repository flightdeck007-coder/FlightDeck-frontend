    ...
    <div className="h-full bg-card border-r border-border flex flex-col w-full">
      ...
      <div className="p-4 border-b border-border">
        ...
        <div className="flex items-baseline justify-between gap-4 mb-1">
          ...
          <span className="text-sm font-medium text-foreground/80">Current Leg: <span className="font-bold text-foreground">{segmentTime}</span></span>
        </div>
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            title={!isFacilitator ? 'Only the Pilot In Charge can change segment' : undefined}
          >
          ...
          {isSuspended && onResumeFromSuspend ? (
            <button
              ...
              aria-label="Resume"
              title={!isFacilitator ? 'Only the Pilot In Charge can control the timer' : undefined}
            >
          ...
          {onSuspend && (
            <button
              ...
              title={!isFacilitator ? 'Only the Pilot In Charge can suspend' : undefined}
            >
              HOLD
            </button>
          )}
          ...
          <>
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
              <div className="bg-card border border-border rounded-xl shadow-xl max-w-sm w-full p-6 relative">
                ...
                <h3 className="text-xl font-bold text-red-600 pr-8">Off Course Alert!</h3>
              ...
              <div className="bg-card border border-border rounded-xl shadow-xl max-w-md w-full max-h-[80vh] flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto p-4 min-h-0">
                  {fetchedMeeting && !participantsLoading && (
                    <div className="mb-4 p-3 rounded-lg border border-border bg-muted/20 space-y-2">
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="text-muted-foreground">Pilot In Charge:</span>
                      ...
                      <div className="flex items-center justify-between gap-2 text-sm">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-muted-foreground">Safety Officer:</span>
                          <span className="font-medium text-foreground">
                  ...
                  {participantsLoading ? (
                    ...
                    <p className="text-sm text-muted-foreground">No participants in this flight review.</p>
                  ) : (
              ...
              <>
                ...
                <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
                  <div className="bg-card border border-border rounded-xl shadow-xl max-w-md w-full flex flex-col max-h-[85vh]">
                    <div className="flex items-center justify-between p-4 border-b border-border shrink-0">
                      <h3 className="text-lg font-semibold text-foreground">Change safety officer</h3>
                      <button
                        type="button"
                    ...
                    <div className="flex-1 overflow-y-auto p-4 min-h-0">
                      <p className="text-sm text-muted-foreground mb-4">
                        Select a crew member. They will be able to add and edit notes, clearances, and turbulence.
                      </p>
                      <Select
